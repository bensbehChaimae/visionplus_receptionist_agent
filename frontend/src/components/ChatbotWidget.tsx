      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 z-50 w-[calc(100%-3rem)] sm:w-full sm:max-w-md h-[600px] max-h-[calc(100vh-200px)] shadow-2xl"
          >
            <Card className="shadow-2xl border-2 border-blue-200 h-full flex flex-col">
              <CardHeader className="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-4 rounded-t-lg flex-shrink-0">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-lg font-semibold">Vision+ Assistant </h3>
              ...
              <CardContent className="p-0 flex flex-col flex-1 overflow-hidden rounded-lg">
                {/* Messages Container */}
                <div className="flex-1 overflow-y-auto overflow-x-hidden p-4 space-y-4 bg-gray-50" style={{ minHeight: 0 }}>
                  {messages.length === 0 && (
